...
do
    ...
    cd $project_path/results/ && zip -r $project_path/answer_bert_avg_pw_dist.zip $project_path/answer/ && rm -r $project_path/answer/ && cd $project_path/
    ...
    cd $project_path/results/ && zip -r $project_path/answer_bert_mean_rel_diff.zip $project_path/answer/ && rm -r $project_path/answer/ && cd $project_path/
