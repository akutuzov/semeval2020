...
class DataTrainingArguments:
    ...
    targets_file: Optional[str] = field(
        default=None,
        metadata={"help": "The file containing the target words (a text file)."}
    )
    # --------------
...
def main():
    ...
    model.resize_token_embeddings(tokenizer.vocab_size + n_added_tokens)
    logger.warning(f"{n_added_tokens} new tokens. "
                   f"Old vocab size: {old_vocab_size}. New vocab size: {model.vocab_size}.")
