...
def main():
    ...
    # Get the arguments
    args = docopt("""Compute difference in mean relatedness between two sets of contextualised representations.
    ...
    Options:
        --metric=<d>  The distance metric, which must be compatible with `scipy.spatial.distance.pdist` [default: cosine]
