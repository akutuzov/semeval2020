...
do
    ...
    python3 code/pred_from_senses.py --strength -i0 $data/results/$language/model1.inventory.csv -i1 $data/results/language/model2.inventory.csv > $data/results/$language/wsi_scratch.csv
    ...
    python3 code/pred_from_senses.py --strength -i0 $data/results/$language/model1.inventory.csv -i1 $data/results/language/model2_incremental.inventory.csv > $data/results/$language/wsi_incremental.csv
